            ...
            self.loRa_B = nn.Parameter(
                self.conv3d.weight.new_zeros(
                    (
                        out_channels
                        // self.conv3d.groups
                        * kernel_size[2] ** (self.conv3d.weight.dim() - 3),
...
class Mixed(torch.nn.Module):
    ...
    def unf_lora(self):
        self.branch_1[1].unf_lora()
        self.branch_2[1].unf_lora()
...
class I3D(torch.nn.Module):
    def __init__(
        ...
        # Mixed 5
        self.mixed_5b = Mixed(832, [256, 160, 320, 32, 128, 128], loRa=True)
        self.mixed_5c = Mixed(832, [384, 192, 384, 48, 128, 128], loRa=True)
    ...
    def fix_i3d(self):
        ...
        self.mixed_3b.unf_lora()
        self.mixed_3c.unf_lora()
        self.mixed_4b.unf_lora()
        self.mixed_4c.unf_lora()
        self.mixed_4d.unf_lora()
        self.mixed_4e.unf_lora()
